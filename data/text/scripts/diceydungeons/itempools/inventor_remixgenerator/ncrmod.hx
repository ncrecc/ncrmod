...
var floor1countdowns = [bonetech.pop(),switchcyanide.pop()];
...
var scrapitems = ["Scrap Slingshot", "Scrap Trap", "Scrapsies", "Scrapstick", "Scrap Lamp", "Scrap Crystal", "Scraptula", "Scrap Slam","Oobleck Cauldron","Oobleck Mirror","Oobleck Hammer","Oobleck Missile","Oobleck Hacksaw","Oobleck Capacitor","Oobleck Flamethrower","Oobleck Box","Oobleck Bump","Frozen Oobleck","Ooblock"];

...
var commonlist2 = [pick(["Lightreaver", "Bop Bop"]), "Reverse Emulation", "Forty Cakes", "Pirate a Better Version", "Honeysuckle", "Gas Lamp", "Telephone", "Cookie Cake", "Blacklight", lockpickvariant1];

...
//if(player == 'Warrior') earlytwists.push('The Warrior?'); //stop shifting skillcard, ignore this for regular bonus round
...
var midtwists = ['Mimic?', 'Wizard?', 'Rotten Apple?', 'Cowboy?', 'Alchemist', 'Magician?'];

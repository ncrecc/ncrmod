...
var strangeshop = ["Lightning Rod", "Shriek", "Hammer", "Juggling Ball", "Toxic Ooze", "Candle", "Particle Accelerator", "Flying Skull", "Sledgehammer", "Slingshot", "Fishing Net", "Scissors", "Uberbump", "Humility", "Bizarro Blade", "Doppeldfire", "Undermine"];
strangeshop = shuffle(strangeshop);

//Floor 1:
items = [];
var awesomelist = ["Whip", "Toxic Ooze", "Claw", "Staff", "Hammer", "Shovel", "Battle Axe", "Trident", "Fishing Net", "Gemstone Staff", "Sledgehammer", "Nail Bat", "Quarterstaff", "Shiny Nunchucks", "Heavenly Nectar", "Snare Drum", "Sap Gloves", "Halligan Bar"];
...
//Floor 3:
items = [];
var floor3items = [dicemanip.pop(), "Six Shooter", "Crystal Sword", "Chocolate Cookie", "Blight", "Detonator", "Scissors", "Battle Cry", "Sine Wave", "Last Stand", "Fireworks", dicemanip.pop(), "Rainmaking", "Kale Bat", "Bone Club", "Ice Nine"];
